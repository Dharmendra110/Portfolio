...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_nsjbmla", // 🔹 Replace
        "template_0121dgl", // 🔹 Replace
        form.current,
        "4MWW3tOEg9k4XiKuO",
      )
      .then(
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  <a  href="mailto:dharmendramahilange2020@gmail.com"
          className="text-blue-500 hover:text-blue-400 transition hover:underline duration-300">dharmendramahilange2020@gmail.com </a>
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  <a href="tel:8817899393" className="text-blue-500 hover:text-blue-400 transition hover:underline duration-300">8817899393 </a>
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-medium">Hyderabad, India</p>
              </div>
            </div>
          </div>
        </motion.div>
